...
from projects.models import Project # import to Project app
...
class UserProfile(models.Model):
    ...
    project = models.ManyToManyField(Project, blank=True) # one user can work on multiple projects
    friends = models.ManyToManyField('self', blank=True) # one user can have many friends
    ...
    # Removes a friend from the friends list by their profile ID.
